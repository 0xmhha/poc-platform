...
| **규제 준수** | 규제기관 자금추적, 세금신고, AML/KYT, 준비금 증명 |

### 1.2 핵심 기능 범위

```
┌──────────────────────────────────────────────────────────────────────────┐
│                      StableNet PoC 9대 핵심 기능                          │
├──────────────────────────────────────────────────────────────────────────┤
│                                                                           │
...
│                                                                           │
│  9. 규제 준수 시스템 ─────────────────────────────────── Regulatory      │
│     • Regulatory Viewing Key (규제기관 자금 추적)                         │
│     • Tax Authority Integration (세금 신고 지원)                          │
│     • AML/KYT (Chainalysis, Elliptic 연동)                                │
│     • Proof of Reserve (Chainlink PoR 100% 준비금 증명)                   │
│                                                                           │
└──────────────────────────────────────────────────────────────────────────┘
```
...
| Use Case | 설명 | 관련 기능 |
|----------|------|----------|
| **자금 추적** | 의심 거래 계정의 자금 흐름 추적 | Regulatory Viewing Key |
| **AML/KYT 모니터링** | 실시간 의심거래 탐지 및 위험 평가 | KYT Service (Chainalysis) |
| **세금 정보 조회** | 과세 대상 거래 내역 조회 | Tax Reporter |
| **준비금 검증** | 100% 지급준비금 실시간 확인 | Proof of Reserve |
| **제재 스크리닝** | OFAC 등 제재목록 연동 확인 | KYC Registry |
| **감사 보고서** | 규제 보고용 감사 자료 생성 | Audit Logger |
