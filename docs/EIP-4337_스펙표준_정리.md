...
- `docs/EIP-4337_Paymaster_개발자_구현가이드.md`
  - Paymaster 함수, 입출력, 정책 및 운영 경계를 개발자 관점에서 정리한 문서
- `services/paymaster-proxy/docs/PAYMASTER_SYSTEM_SPEC.md`
  - 현재 Paymaster Proxy 구현의 시스템 명세
